...
export const exportPDF = (vditor: IVditor) => {
    ...
    iframe.contentDocument
        .write(`<link rel="stylesheet" href="${vditor.options.cdn}/index.css"/>
...
<script>
    ...
    Vditor.highlightRender(${JSON.stringify(
        vditor.options.preview.hljs
    )}, previewElement, '${vditor.options.cdn}');
...
<script src="${vditor.options.cdn}/js/icons/${
        vditor.options.icon
    }.js"></script></body></html>`
